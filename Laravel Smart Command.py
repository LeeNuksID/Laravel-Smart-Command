...
class LaravelSmartCommand(sublime_plugin.WindowCommand):
    def __init__(self, *args, **kwargs):
        super(LaravelSmartCommand, self).__init__(*args, **kwargs)
        settings = sublime.load_settings('Laravel Smart Command.sublime-settings')
